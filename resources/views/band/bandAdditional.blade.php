        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">{{$bandAdditional->band->name}} (Additional)</div>
                    <div class="panel-body">
                        <div class="col-xs-12 col-lg-6">
                            <a href="/bands/{{$bandAdditional->band->id}}"><button class="btn btn-info">Basic Info</button></a>
                            ...
                            @endif
                            <form id="banner-upload-form" method="post" action="/bands/{{$bandAdditional->band->id}}/additional/banner" enctype="multipart/form-data">
                                <div>
                            ...
                            <form id="avatar-upload-form" method="post" action="/bands/{{$bandAdditional->band->id}}/additional/avatar" enctype="multipart/form-data">
                                <div>
